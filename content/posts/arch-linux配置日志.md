...
![archlinux展示](../../assets/images/archlinux展示.png)
...
1. 要合并一个文件
(第二次安装现在也留着这个问题)  
![处理pacdiff](../../assets/images/处理pacdiff.png)
...
之前遇到一个问题是 [键位配换](./键位配换.md) 一直设置不成功。然后我自己又写了一个脚本文件。放到系统设置的自动启动里面。但他总是出现各种问题。有时接入个设备他就不灵了。  

不过现在发现原来他自带的可以设置![kde键位设置](../../assets/images/kde键位设置.png)  
### 影响windows显示时间
